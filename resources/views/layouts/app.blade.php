...
<div class="page-scroll">
    <div id="page_container" class="page-container full-width-container bg-move-effect theme-style-dark" data-animation="transition-puff-in">
        ...
        <header id="site_header" class="header">
            <div class="header-content clearfix">
                ...
                <div class="text-logo">
                    <a href="{{ url('/') }}">
                    <div class="logo-symbol bg-danger">G</div>
                        <div class="logo-text">Golden <span class="text-danger">Moses</span></div>
                    </a>
                </div>
                <!-- /Text Logo -->
                ...
                <div class="site-nav mobile-menu-hide">
                    <ul id="menu-classic-menu" class="leven-classic-menu site-main-menu">
						...
						<li id="menu-item-174" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-174"><a href="{{ url('contact') }}" data-hover="1">Contact ME</a></li>
